...
export function ShortlistPage() {
  ...
  const getProfilePngUrl = (attempt: AttemptCatalogRow | null): string | null => {
    if (!attempt) return null;
    const drop = profileDrops.find(d => d.attempt_id === attempt.attempt_id);
    return drop?.png_url ?? attempt.profile_path_url ?? null;
  };
  ...
  return (
    <>
      ...
      <ProfileDropModal
        ...
        profilePathUrl={getProfilePngUrl(selectedAttempt)}
