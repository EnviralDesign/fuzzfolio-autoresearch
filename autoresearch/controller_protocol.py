...
- Indicator composition: prefer candidates that combine context/filter + setup/state + a fresh entry trigger. Use overlapping role timeframes by default: context/filter M30/H1/H4/D1, setup M5/M15/M30/H1, triggers M1/M5/M15. Current seed hands may be state-heavy; when a run reference provides role-balanced indicator guidance, use it before building all-state scaffolds.
