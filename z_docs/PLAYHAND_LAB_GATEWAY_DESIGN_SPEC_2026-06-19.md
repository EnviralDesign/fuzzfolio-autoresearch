...
- The coordinator now creates and enqueues runs in bounded rolling chunks. Finite campaigns stop creating work after `--target-runs` and drain; continuous campaigns keep replacing completed runs until the process is stopped.
