...
$OutDir = Join-Path $Root "runs\derived\playhand-prior-test-clean-50-family-policy-v1"
...
"[$startedAt] Starting clean 50-seed Play Hand family-policy confirmation batch" | Add-Content -Path $BatchLog -Encoding UTF8
...
"[$finishedAt] Finished clean 50-seed Play Hand family-policy confirmation batch completed=$completed failed=$failed skipped=$skipped" | Add-Content -Path $BatchLog -Encoding UTF8
