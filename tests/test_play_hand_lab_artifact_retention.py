...
def test_play_hand_lab_default_retention_writes_canonical_artifacts_only(
    ...
    result = lab._record_lab_result(
        ...
        lab_result={
            ...
            "result": {
                ...
                "lake_cache": {"elapsed_seconds": 1.0},
                "request": {"instruments": ["EURUSD"], "lookback_months": 3},
                "result": {
                    "aggregate": {"score_lab": {"score": 12.0}},
    ...
    duplicate = lab._record_lab_result(
        ...
        lab_result={
            ...
            "lease_id": "lease-redelivery",
            "accepted_at": 2.0,
            "result": {
                "job_id": "redelivery-job",
                "status": "success",
                "worker_id": "worker-redelivery",
                "worker_lease_id": "lease-redelivery",
                "started_at": "2026-07-18T00:01:00Z",
                "completed_at": "2026-07-18T00:01:09Z",
                "duration_seconds": 9.0,
                "lake_cache": {"elapsed_seconds": 2.0},
                "request": {"instruments": ["EURUSD"], "lookback_months": 3},
                "result": {
                    "aggregate": {"score_lab": {"score": 12.0}},
                    "performance": {"total_compute_seconds": 9.0},
                },
            },
        },
        reward_matrix=None,
